...
<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}">
  ...
  <text x="60" y="${HEIGHT - 15}" fill="#00ff88" font-family="'JetBrains Mono', 'Courier New', monospace" font-size="22" font-weight="700" letter-spacing="8">LISTENABLE MUSIC</text>
  <text fill="#cccccc" font-family="'JetBrains Mono', 'Courier New', monospace" font-size="20" font-weight="400" letter-spacing="2" x="1140" y="${HEIGHT - 16}" text-anchor="end">listenablemusic.ca</text>
